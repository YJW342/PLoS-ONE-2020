...
filename=strcat('shift_worker_shift_10000lux_10pm','.mat');
save(filename,'Sleep','x','xc','I','u','H','R','n','T_optimal')



% Optimal entrainment during shift with optimal entrainment afterware
clear all;
close all;
clc;
bdclose('all');
global Sleep u H x xc T_opt n I
load('Periodic_Solution_Sleep_I.mat');
...
filename=strcat('shift_worker_shift10000lux_optimal','.mat');
save(filename,'Sleep','x','xc','I','u','H','R','n','T_optimal')
