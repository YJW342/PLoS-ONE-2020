%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Jiawei Yin
% Gradient descent method for sleep schedule and light of circadian entrainment of international travelers (training cases in Section 4.1.1-4.1.2);
clear all;
close all;
clc;
bdclose('all');
...
% Gradient descent method for sleep schedule and light of circadian entrainment of international travelers (training cases in Section 4.1.3);
clear all;
close all;
clc;
bdclose('all');
...
tol=0.01;Ac=0.1333;tr=18.2;td=4.2;omega0=2*pi/24.2;alpha0=0.05;
q = 1/3;taux = 24.2;k = 0.55;mu=0.13;G=33.75;p=0.5;I0=9500;beta=0.0075;
Initial_Time=4; % Initial_Time=4 for Case a in Section 4.1.4, Initial_Time=16 for Case a in Section 4.1.4;
